                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-lg font-semibold text-gray-900">{result.companyIntel.name}</h3>
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                        result.companyIntel.size === 'Enterprise' ? 'bg-purple-100 text-purple-700' :
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-600 mb-3">
                      ...
                      <span className="flex items-center gap-1">
                        ...
                        {result.companyIntel.size === 'Enterprise' ? '2000+ employees' :
                         result.companyIntel.size === 'Mid-size' ? '200-2000 employees' :
                         '< 200 employees'}
                      </span>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-600">{result.companyIntel.hiringFocus}</p>
                    </div>
              ...
              <CardContent>
                <div className="relative">
                  ...
                  <div className="space-y-6">
                    {result.roundMapping.map((round, index) => (
                      <div key={round.round} className="relative flex gap-4">
                        ...
                        <div className={`relative z-10 w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 ${
                          ...
                          index === result.roundMapping!.length - 1 ? 'bg-green-500 text-white' :
                        ...
                        <div className="flex-1 pb-2">
                          <div className="bg-gray-50 rounded-lg p-4">
                            ...
                            <div className="mb-3">
                              <span className="text-xs font-medium text-primary uppercase tracking-wide">Why this matters</span>
                              <p className="text-sm text-gray-600 mt-1">{round.whyItMatters}</p>
                            </div>
                            
                            <div className="flex flex-wrap gap-2">
                              {round.focusAreas.map((area, i) => (
